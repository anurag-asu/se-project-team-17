...
def refine_dataset():
    ...
    for i in range(len(FAILED_URLS)):
        ...
        df.loc[df['pj_github_url'] == failed_url, 'corrected_pj_github_url'] = failed_url_corrected
        df.loc[df['pj_github_url'] == failed_url, 'correct_url_found'] = failed_url != failed_url_corrected
