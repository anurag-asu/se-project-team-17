...
def logic_coupling_index():
    ...
    for repo in repos:
        ...
        try:
            calculated = float(df.loc[df['corrected_pj_github_url'] == repo, 'logic_coupling_index'])
            if calculated > 0.0:
                continue
            ...
            df.loc[df['corrected_pj_github_url'] == repo, 'logic_coupling_index'] = logic_coupling_index
